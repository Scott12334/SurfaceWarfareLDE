...
public class ContactControl : MonoBehaviour
{
    ...
    void addCurrentContacts(){
        switch(currentMin){
            //Minute 0
            case 0:
            contacts.Add(new ContactManager("001",65,20,"7 35'45\":135 00'45\"","Cargo"));
            ...
            contacts.Add(new ContactManager("004",65,10,"7 45'00\":134 56'30\"","Cargo"));
            contacts.Add(new ContactManager("005",25,15,"7 41'45\":134 55'00\"","Fishing"));
            contacts.Add(new ContactManager("006",300,25,"7 38'30\":134 58'14\"","Wig"));
            contacts.Add(new ContactManager("007",60,20,"7 35'45\":135 00'30\"","Cargo"));
            contacts.Add(new ContactManager("008",59,12,"7 44'30\":134 57'00\"","Cargo"));
            ...
            contacts.Add(new ContactManager("121",66,200,"7 34'34\":134 44'30\"","Private Jet"));
            break;

            //Minute 5
            case 1:
            contacts.Add(new ContactManager("011",220,17,"7 45'30\":135 05'30\"","AGS Ship"));
            ...
            contacts.Add(new ContactManager("015",45,20,"7 39'45\":134 55'15\"","Merchant"));
            contacts.Add(new ContactManager("016",15,25,"7 41'15\":134 55'00\"","Merchant"));
            contacts.Add(new ContactManager("017",45,20,"7 40'30\":134 53'45\"","Tanker"));
            ...
            contacts.Add(new ContactManager("019",7,30,"7 33'00\":134 53'30\"","Unknown Civilian"));
            ...
            contacts.Add(new ContactManager("108",238,200,"7 45'30\":135 09'15\"","High Altitude Chinese Plane"));
            break;

            //Minute 15
            case 3:
            contacts.Add(new ContactManager("021",57,20,"7 41'30\":134 51'45\"","Cargo"));
            contacts.Add(new ContactManager("022",42,15,"7 30'45\":134 58'45\"","Oiler"));
            ...
            contacts.Add(new ContactManager("027",42,15,"7 32'30\":134 49'30\"","Armed Cargo"));
            break;

            //Minute 25
            case 5:
            contacts.Add(new ContactManager("028",40,20,"7 24'30\":134 50'30\"","Armed Cargo"));
            contacts.Add(new ContactManager("029",40,20,"7 23'45\":134 49'45\"","Armed Cargo"));
            contacts.Add(new ContactManager("030",40,20,"7 25'15\":134 51'00\"","Patrol Craft"));
            ...
            contacts.Add(new ContactManager("032",103,25,"7 34'00\":134 47'00\"","Merchant"));
            ...
            contacts.Add(new ContactManager("110",60,800,"7 16'30\":134 36'30\"","Chinese Fighter"));
            contacts.Add(new ContactManager("111",200,300,"7 40'00\":134 53'00\"","Chinsese Surveliance Plane"));
            break;

            //Minute 45
            case 9:
            contacts.Add(new ContactManager("034",277,30,"7 17'00\":134 51'30\"","DDG"));
            contacts.Add(new ContactManager("035",277,30,"7 16'15\":134 51'15\"","DDG"));
            contacts.Add(new ContactManager("036",277,30,"7 16'30\":134 52'45\"","CVN"));
            break;

            //Minte 50
            case 10:
            contacts.Add(new ContactManager("037",277,30,"7 17'45\":134 50'31\"","CG"));
            contacts.Add(new ContactManager("038",277,30,"7 16'00\":134 50'00\"","CG"));
            break;
        }
    }
}
